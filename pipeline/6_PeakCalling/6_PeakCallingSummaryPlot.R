...
peakpath <- paste0(projectPath, "/alignment/summary_peak_calling_norm_AmpR.txt")
peakWidthPath <- paste0(projectPath, "/alignment/summary_peak_calling_norm_width_AmpR.txt")
fripsPath <- paste0(projectPath, "/alignment/summary_peak_calling_frips_ampr.txt")
...
split_results <- strsplit(frips$Histone, "[.]")
split_results
frips$cellLine <- sapply(split_results, `[`, 1)
