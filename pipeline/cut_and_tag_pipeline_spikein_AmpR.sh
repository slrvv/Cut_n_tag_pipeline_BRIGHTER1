...
SPIKEINAMPR=$PIPELINE/2_Alignment/2bis_SpikeInAlignment_AmpR.sh
...
SPIKEINSUMAMPR=$PIPELINE/3_AssessAlignment/3_SpikeinSummary_AmpR.R
#Filterandconvert
...
PEAKSAMPR=$PIPELINE/6_PeakCalling/6_PeakCalling_AmpR.sh
PEAKSUMM=$PIPELINE/6_PeakCalling/6_PeakCallingSummary.R
PEAKSUMMAMPR=$PIPELINE/6_PeakCalling/6_PeakCallingSummary_AmpR.R
PEAKAMPR=$PIPELINE/6_PeakCalling/6_PeakCallingSummary_AmpR.R
PEAKSFRIP=$PIPELINE/6_PeakCalling/6_PeakCallingFrips_AMPR.R
...
MERGEPEAKSAMPR=$PIPELINE/6_PeakCalling/6_MergingReplicates_AmpR.sh
RMBLACKLIST=$PIPELINE/6_PeakCalling/6_RemoveBlacklist.sh
RMBLACKLISTAMPR=$PIPELINE/6_PeakCalling/6_RemoveBlacklist_AmpR.sh
...
# 
# # This is for the Schulz lab AmpR spikein
# refspike=/project/ChromGroup_Seq_data/Celeste/2025_02/spike_in_test/bowtie2Index/hg38_ampr
# #Human chromsizes
...
#    echo "Name of R1 ${split[1]}"
#    echo "Name of R2 ${split[2]}"
#    bash $SPIKEINAMPR $PROJECTROOT $RAWROOT/${split[1]} \
...
# Rscript $SPIKEINSUMAMPR $PROJECTROOT $EXPSUMMARYAL
# ##
...
# set $line
# IFS=$','; split=($line); unset IFS;
# bedGraphToBigWig $PROJECTROOT/alignment/bedgraph/${split[0]}_bowtie2.fragments.filtered.normalized.AmpR.bedgraph \
# $chromSize $PROJECTROOT/alignment/bigwig/${split[0]}_bowtie2.fragments.filtered.normalized.AmpR.bw
# done < <(tail -n +2 $EXPSUMMARYAL)
# 
...
#      IFS=$','; split=($line); unset IFS;
#      echo "${split[0]}"
#      bash $PEAKSAMPR $PROJECTROOT ${split[1]} ${split[0]}
# done < <(tail -n +2 $EXPSUMMARYPEAKS)
# # #
##Create summary statistics on the peaks called
#Rscript $PEAKSUMMAMPR $PROJECTROOT $EXPSUMMARYPEAKS #Reproducibility and summary

#bash FilterChrom.sh

#Rscript $PEAKSUMMFILT $PROJECTROOT $EXPSUMMARYPEAKS
...
# for sample in HBD.gfp HBD.flag HBD.his HBD.rpa70 HBD.h3k36me3 HBD.h3k4me3 \
# WKK.gfp WKK.flag WKK.his WKK.h3k4me3 WT.gfp WT.flag WT.his WT.rpa70 WT.h3k36me3 WT.h3k4me3 ; do
#   bash $MERGEPEAKSAMPR $PROJECTROOT $sample
# donehttp://127.0.0.1:39221/graphics/7ff9336f-5d49-4532-85d2-29742077baea.png
# # 
# for sample in HBD.gfp HBD.flag HBD.his HBD.rpa70 HBD.h3k36me3 HBD.h3k4me3 \
# WKK.gfp WKK.flag WKK.his WKK.h3k4me3 WT.gfp WT.flag WT.his WT.rpa70 WT.h3k36me3 WT.h3k4me3 ; do
#   bash $RMBLACKLISTAMPR $PROJECTROOT $sample
# done
...
# for sample in HBD.gfp HBD.flag HBD.his HBD.rpa70 HBD.h3k4me3 \
#    WKK.gfp WKK.flag WKK.his WKK.h3k4me3 WT.gfp WT.flag WT.his WT.rpa70 WT.h3k4me3 ; do
#       prun python bigwigCompare -b1 $bwPath/${sample}_1_${bwSuffix} -b2 $bwPath/${sample}_2_${bwSuffix} \
#       --operation mean -o $bwPath/${sample}_${bwSuffix}
# done
...
#   WKK.gfp WKK.flag WKK.his WKK.h3k4me3 WT.gfp WT.flag WT.his WT.rpa70 WT.h3k4me3 ; do
#   
#   bash $RMBLACKLIST $PROJECTROOT $sample
# done 

# bwSuffix=bowtie2.fragments.filtered.normalized.AmpR.bw
# bwPath=$PROJECTROOT/alignment/bigwig
# 
# for sample in HBD.gfp HBD.flag HBD.igg HBD.his HBD.rpa70 HBD.h3k36me3 HBD.h3k4me3 \
# WKK.igg WKK.gfp WKK.flag WKK.his WKK.h3k4me3 WT.gfp WT.igg WT.flag WT.his WT.rpa70 \
# WT.h3k36me3 WT.h3k4me3 ; do
#      prun python bigwigCompare -b1 $bwPath/${sample}_1_${bwSuffix} -b2 $bwPath/${sample}_2_${bwSuffix} \
#      --operation mean -o $bwPath/${sample}_${bwSuffix}
# done
